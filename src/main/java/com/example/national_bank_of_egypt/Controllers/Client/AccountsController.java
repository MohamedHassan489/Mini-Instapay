...
public class AccountsController implements Initializable {
        ...
        try {
            ...
            if (Model.getInstance().getCurrentUser() != null) {
                if (accounts_list != null) {
                    ...
                    // Set custom cell factory to display account information with better styling for scrolling
                    accounts_list.setCellFactory(listView -> {
                        ...
                        cell.selectedProperty().addListener((obs, wasSelected, isNowSelected) -> {
                            if (cell.getItem() != null) {
                                if (isNowSelected) {
                                    cell.setStyle("-fx-font-size: 12px; -fx-padding: 10px; -fx-background-color: #e3f2fd; -fx-border-color: #2196F3; -fx-border-width: 0 0 2 0; -fx-font-weight: bold;");
                                } else {
                                    cell.setStyle("-fx-font-size: 12px; -fx-padding: 10px; -fx-background-color: #f9f9f9; -fx-border-color: #e0e0e0; -fx-border-width: 0 0 1 0;");
                                }
                            }
                        });
                    ...
                    accounts_list.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                        if (newVal != null) {
                            ...
                            if (account_num_lbl != null) account_num_lbl.setText("-");
                            if (bank_name_lbl != null) bank_name_lbl.setText("-");
                            if (balance_lbl != null) balance_lbl.setText("$0.00");
                            if (account_type_lbl != null) account_type_lbl.setText("-");
                            if (update_bank_name_fld != null) update_bank_name_fld.setText("");
                            if (update_account_type_combo != null) update_account_type_combo.setValue(null);
                        }
                    });
    ...
    private void onAddAccount() {
        ...
        if (add_account_error_lbl != null) {
            add_account_error_lbl.setText("");
        }
        ...
        if (accountNumber.isEmpty() || bankName.isEmpty() || accountType == null || balanceStr.isEmpty()) {
            if (add_account_error_lbl != null) {
                add_account_error_lbl.setText("Please fill all required fields");
            }
            return;
        }
        ...
        if (!accountNumber.matches("^[A-Za-z0-9]{6,20}$")) {
            if (add_account_error_lbl != null) {
                add_account_error_lbl.setText("Account number must be 6-20 alphanumeric characters");
            }
            return;
        }
        ...
        try {
            ...
            if (balance < 0) {
                if (add_account_error_lbl != null) {
                    add_account_error_lbl.setText("Balance cannot be negative");
                }
                return;
            }
        } catch (NumberFormatException e) {
            if (add_account_error_lbl != null) {
                add_account_error_lbl.setText("Please enter a valid balance amount");
            }
            return;
        }
        ...
        if (Model.getInstance().getCurrentUser() != null) {
            for (BankAccount acc : Model.getInstance().getCurrentUser().getBankAccounts()) {
                if (acc.getAccountNumber().equals(accountNumber)) {
                    if (add_account_error_lbl != null) {
                        add_account_error_lbl.setText("Account number already exists");
                    }
                    return;
                }
            }
        ...
        if (Model.getInstance().addBankAccount(accountNumber, bankName, balance, accountType)) {
            ...
            successAlert.setContentText("Bank account has been added successfully!");
            successAlert.showAndWait();
            
            // Clear form
            if (new_account_num_fld != null) new_account_num_fld.setText("");
            if (new_bank_name_fld != null) new_bank_name_fld.setText("");
            if (new_balance_fld != null) new_balance_fld.setText("");
            if (account_type_combo != null) account_type_combo.setValue("Checking");
            ...
            if (add_account_error_lbl != null) {
                add_account_error_lbl.setText("Failed to add account. Account number may already exist.");
            }
        }
    }
    ...
    private void onRemoveAccount() {
        // Clear previous error
        if (remove_account_error_lbl != null) {
            remove_account_error_lbl.setText("");
        }
        
        // Get selected account
        BankAccount selectedAccount = accounts_list != null ? accounts_list.getSelectionModel().getSelectedItem() : null;
        
        if (selectedAccount == null) {
            if (remove_account_error_lbl != null) {
                remove_account_error_lbl.setText("Please select an account to remove");
            }
            return;
        }
        ...
        confirmAlert.setTitle("Confirm Account Removal");
        confirmAlert.setHeaderText("Remove Bank Account");
        confirmAlert.setContentText("Are you sure you want to remove account " + selectedAccount.getAccountNumber() + 
        ...
        confirmAlert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                ...
                if (Model.getInstance().getCurrentUser() != null && 
                    ...
                    if (remove_account_error_lbl != null) {
                        remove_account_error_lbl.setText("Cannot remove the last account. You must have at least one account.");
                    }
                    return;
                }
                ...
                if (Model.getInstance().removeBankAccount(selectedAccount.getAccountNumber())) {
                    ...
                    Alert successAlert = new Alert(Alert.AlertType.INFORMATION);
                    successAlert.setTitle("Success");
                    successAlert.setHeaderText("Account Removed");
                    successAlert.setContentText("Bank account has been removed successfully!");
                    successAlert.showAndWait();
                    ...
                    if (remove_account_error_lbl != null) {
                        remove_account_error_lbl.setText("Failed to remove account. Please try again.");
                    }
                }
            }
        });
    ...
    private void onUpdateAccount() {
        // Clear previous error
        if (update_account_error_lbl != null) {
            update_account_error_lbl.setText("");
        }
        ...
        if (selectedAccount == null) {
            if (update_account_error_lbl != null) {
                update_account_error_lbl.setText("Please select an account to update");
            }
            return;
        }
        ...
        if (bankName.isEmpty() || accountType == null || accountType.isEmpty()) {
            if (update_account_error_lbl != null) {
                update_account_error_lbl.setText("Please fill all fields");
            }
            return;
        }
        ...
        if (Model.getInstance().updateBankAccount(selectedAccount.getAccountNumber(), bankName, accountType)) {
            ...
            Alert successAlert = new Alert(Alert.AlertType.INFORMATION);
            successAlert.setTitle("Success");
            successAlert.setHeaderText("Account Updated");
            successAlert.setContentText("Bank account information has been updated successfully!");
            successAlert.showAndWait();
            ...
            if (update_account_error_lbl != null) {
                update_account_error_lbl.setText("Failed to update account. Please try again.");
            }
        }
    }
}
